...
export default function Home() {
  return (
    <main>
      ...
      <InfiniteMovingCards
        className="md:mt-[30rem]"
        items={clients}
        direction="right"
        speed="slow"
      />
      <section className="mt-[-8rem] h-full">
        <HeroParallax products={products} />
      </section>
      <section className="mt-1000px">
        <LampComponent />
        <div className="flex flex-wrap items-center justify-center fix-col md:flex-row gap-8 mt-[-15rem] pb-[2rem]">
          {/* -------------------------------------------------------------------------------------------------------------- */}
